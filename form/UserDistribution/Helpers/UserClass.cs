...
namespace SewingProduction.form.UserDistribution
{
    public class UserClass
    {
        ...
        {
            System.Data.DataTable UserData = await _userClassDataService.GetUserData(UserId);
        ...
        public bool HasPermission(string objectName, string permissionType)
        {
            ...
            foreach (System.Data.DataRow row in myObjectForm.Rows)
            {
    ...
    public class UserClassDataService
    {
        ...
        public async Task<System.Data.DataTable> GetUserData(int UserId)
        {
        ...
        public async Task<System.Data.DataTable> GetObjectForm(int UserId, string NameForm)
        {
            string query = $@"
