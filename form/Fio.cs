...
namespace SewingProduction.form
{
    public partial class Fio : CustomForm
    {
        ...
        {
            fioList.DataSource = _artNormService.GetFioAndSpFirmsAndBrigObjectAndSpBrigAndSpisok1c();
        ...
        private void customButtonPchShk_Click(object sender, EventArgs e)
        {
            ...
            customComboBoxPechVed.DataSource = _artNormService.GetBrigVed();
        ...
        private void radioGroup1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                customComboBoxOtch.DataSource = _artNormService.GetFioDolgnPodr1c(customLabelOtch.Text);
        ...
        {
            for_reports_excel.DataSource = _artNormService.GetFioAndSpFirmsAndTabN();
        ...
        {
            for_reports_excel.DataSource = _artNormService.GetFioDolgnPogr1cWhere(customLabelOtch.Text, customComboBoxOtch.Text, customCheckBoxOsnTab.Checked);
            if (for_reports_excel.DataSource == null) { return; }
            // Генерируем отчёт
            ExcelReportGenerator generator = new ExcelReportGenerator();
            try
        ...
        private void customButtonAddSov_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                _artNormService.UpdateFioSovm(tab);

                // 3.  Получение нового табельного номера
                int newTabSovm = _artNormService.GetFioNewTab();

                // 4. Получение данных для XML
                System.Data.DataTable sqlFio = _artNormService.GetFioForXML(tab);
                ...
                _artNormService.SetFioInsertTableXml(xmlFio);
