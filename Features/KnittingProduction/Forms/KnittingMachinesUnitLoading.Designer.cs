namespace SewingProduction.Features.KnittingProduction.Forms
{
    partial class KnittingMachinesUnitLoading
    {
        ...
        private void InitializeComponent()
        {
            ...
            gridViewPlanSezonZadKnitMachine.Columns.AddRange(new DevExpress.XtraGrid.Columns.GridColumn[] { gridPlanSezonZadKnitMachineColumnArticul, gridPlanSezonZadKnitMachineColumnPszkmPszNom, gridPlanSezonZadKnitMachineColumnHoursTotal, gridPlanSezonZadKnitMachineColumnDateZap, gridPlanSezonZadKnitMachineColumnPszkmPlanDateFrom, gridPlanSezonZadKnitMachineColumnPszkmPlanDateTo, gridPlanSezonZadKnitMachineColumnYearMonthPlanDate, gridPlanSezonZadKnitMachineColumnKmlNumber, gridPlanSezonZadKnitMachineColumnYearNumberPlanDate, gridPlanSezonZadKnitMachineColumnMonthNumberPlanDate, gridPlanSezonZadKnitMachineColumnYearMonthText });
            ...
            gridViewPlanSezonZadKnitMachine.GroupSummary.AddRange(new DevExpress.XtraGrid.GridSummaryItem[] { new DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Sum, "hoursTotal", gridPlanSezonZadKnitMachineColumnHoursTotal, "(Итого по в/м, ч/ч: {0:0.##})") });
            ...
            gridPlanSezonZadKnitMachineColumnHoursTotal.Summary.AddRange(new DevExpress.XtraGrid.GridSummaryItem[] { new DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "hoursTotal", "(Итого по в/м, ч/ч: {0:0.##})") });
            ...
            ClientSize = new System.Drawing.Size(844, 687);
            Controls.Add(labelKmlNumber);
            Controls.Add(gridControlPlanSezonZadKnitMachine);
