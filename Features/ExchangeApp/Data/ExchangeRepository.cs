...
namespace ExchangeApp.Data
{
    public sealed class ExchangeRepository
    {
        ...
        private NpgsqlConnection CreateConnection()
        {
            ...
            return new NpgsqlConnection(_dbHelper.GetConnection().ToString());
        }
...
order by f.frm_id;";
            ...
            await using var cn = _dbHelper.GetConnection();
            await cn.OpenAsync();
...
declare
    v_batch_id bigint;
begin
    call exchange.usp_export_akt_furn_data(
...
declare
    v_request_id bigint;
begin
    call exchange.usp_create_export_request_for_documents(
...
declare
    v_batch_id bigint;
begin
    call exchange.usp_export_akt_furn_by_request(
