CREATE VIEW dbo.articulListGroupBySizeLabeltb 
AS WITH PlanTb AS
(
    SELECT 
        kodd,
...
EXEC sys.sp_addextendedproperty N'MS_Description', N'Вьюшка на время теста с указанием Блока, в котором запланирована модель. Основная articulListGroupBySizeLabel уже в работе, эту, наверное,  можно удалить', 'SCHEMA', N'dbo', 'VIEW', N'articulListGroupBySizeLabeltb'
GO